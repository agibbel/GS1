...
namespace Tepliakov.GS1Utils.AI
{
    ...
    /// </summary>
    /// <see cref="https://www.gs1.org/docs/barcodes/GS1_General_Specifications.pdf#%5B%7B%22num%22%3A491%2C%22gen%22%3A0%7D%2C%7B%22name%22%3A%22XYZ%22%7D%2C50%2C287%2C0%5D"/>
    [AI("17", "EXPIRY", "Expiration date: AI (17)", 6)]
    public class ExpirationDate : AIBaseDate
    {
        /// <summary>
        /// Создает объект AI (17) Expiration date
        /// </summary>
        ...
        public ExpirationDate(string src) : base(src)
        {
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">значение даты выходит за допустимый диапазон</exception>
        public ExpirationDate(int year, int month, int day) : base(year, month, day)
        {
        }
    }
}
