...
namespace Tepliakov.GS1Utils.AI
{
    ...
    /// </summary>
    /// <see cref="https://www.gs1.org/docs/barcodes/GS1_General_Specifications.pdf#%5B%7B%22num%22%3A485%2C%22gen%22%3A0%7D%2C%7B%22name%22%3A%22XYZ%22%7D%2C50%2C624%2C0%5D"/>
    [AI("12", "DUE DATE", "Due date for amount on payment slip: AI (12)", 6)]
    public class DueDate : AIBaseDate
    {
        /// <summary>
        /// Создает объект AI (12) Due date
        /// </summary>
        ...
        public DueDate(string src) : base(src)
        {
        }
        ...
        public DueDate(DateTime date) : base(date)
        {
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">значение даты выходит за допустимый диапазон</exception>
        public DueDate(int year, int month, int day) : base(year, month, day)
        {
        }
    }
}
